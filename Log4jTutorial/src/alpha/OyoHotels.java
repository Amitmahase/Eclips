...
public class OyoHotels {
	...
	private static Logger log=LogManager.getLogger(OyoHotels.class.getName());
public static void main(String[] args) throws InterruptedException {
		...
		log.info("serching in bangalore");
		...
		log.info("Searching for specific hotel");
